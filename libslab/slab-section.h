...
#define SLAB_SECTION(o)           (G_TYPE_CHECK_INSTANCE_CAST ((o), SLAB_SECTION_TYPE, SlabSection))
#define SLAB_SECTION_CLASS(c)     (G_TYPE_CHECK_CLASS_CAST ((c), SLAB_SECTION_TYPE, SlabSectionClass))
#define IS_SLAB_SECTION(o)        (G_TYPE_CHECK_INSTANCE_TYPE ((o), SLAB_SECTION_TYPE))
#define IS_SLAB_SECTION_CLASS(c)  (G_TYPE_CHECK_CLASS_TYPE ((c), SLAB_SECTION_TYPE))
#define SLAB_SECTION_GET_CLASS(o) (G_TYPE_CHECK_GET_CLASS ((o), SLAB_SECTION_TYPE, SlabSectionClass))
...
#define SLAB_LEFT_PADDING 10
	...
	Style2			/* SlabSections in right pane - padding,
				   label text changes as group is selected */
} SlabStyle;
