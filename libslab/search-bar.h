...
void nld_search_bar_set_show_contexts (NldSearchBar * search_bar,
				       gboolean show_contexts);
void nld_search_bar_add_context (NldSearchBar * search_bar,
				 const char *label,
...
void nld_search_bar_set_text (NldSearchBar * search_bar,
			      const char *text, gboolean activate);

int nld_search_bar_get_context_id (NldSearchBar * search_bar);
void nld_search_bar_set_context_id (NldSearchBar * search_bar,
				    int context_id);
