...
#define TILE_ACTION_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), TILE_ACTION_TYPE, TileActionPrivate))
     ...
     static void
       tile_action_class_init (TileActionClass * this_class)
{
...
TileAction *
tile_action_new (Tile * tile, TileActionFunc func,
...
tile_action_set_menu_item_label (TileAction * this, const gchar * markup)
{
	...
	if (this->menu_item) {
		...
		g_signal_connect (G_OBJECT (this->menu_item),
				  "activate",
				  G_CALLBACK
				  (tile_action_menu_item_activate_cb), this);
	}
}
...
static void
tile_action_menu_item_activate_cb (GtkMenuItem * menu_item,
				   gpointer user_data)
{
