...
GType
egg_recent_item_get_type (void) G_GNUC_CONST;
...
gboolean egg_recent_item_in_group (const EggRecentItem * item, const gchar * group_name);

void egg_recent_item_add_group (EggRecentItem * item, const gchar * group_name);

void egg_recent_item_remove_group (EggRecentItem * item, const gchar * group_name);

void egg_recent_item_set_private (EggRecentItem * item, gboolean priv);
